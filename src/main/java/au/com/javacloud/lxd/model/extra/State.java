...
public class State {
    ...
    public String toString() {
        return "pid="+pid+" processes="+processes+
                " memory="+getMemoryInMB(MemoryEnum.USAGE)+"M/"+getMemoryInMB(MemoryEnum.USAGE_PEAK)+"M"+
                " swap="+getMemoryInMB(MemoryEnum.SWAP_USAGE)+"M/"+getMemoryInMB(MemoryEnum.SWAP_USAGE_PEAK)+"M"+
                " network="+network;
    }
    enum MemoryEnum {
